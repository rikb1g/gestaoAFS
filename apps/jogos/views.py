...
def intervalo_jogo(request,id_jogo):
    ...
    try:
        ...
        for atleta_id in atletas_ids:
            ...
            HistoricoSubstituição.objects.create(jogo=jogo, atleta=atleta_estatistica.atleta, entrou=atleta_estatistica.inicio, saiu=atleta_estatistica.fim, total_minutos=atleta_estatistica.total_minutos)
...
def golo(request, atleta_id, jogo_id):
    try:
        ...
        estatistica.golos += 1
        estatistica.save()
        print(estatistica.jogo.visitado)
        print(atleta.equipa)
